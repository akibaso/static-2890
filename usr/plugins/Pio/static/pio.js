...
var Paul_Pio = function (prop) {
    ...
    var action = {
        ...
        // 触摸//prop.content.touch ||
        touch: function () {
            current.canvas.onclick = function () {
                modules.render( ["会逞强呀...女孩子的话","因为我是个怕麻烦的人啊。尽管最近总是被人说我很麻烦，可是我自己却很怕麻烦啊。","对你来说，伦也可能是独一无二、不可替代的。可对我来说，他根本没有什么特别的，普通得无以复加。所以，我才会想，他就……挺好的。","可能你无法接受，可能你会因此对我产生反感。可是……这跟我又有什么关系啊！","巡璃这个女孩子，一直很珍视自己的伙伴，一直很喜爱自己的挚友。……作品中的设定，就是这样的。"]);
            };
        },
